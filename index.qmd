...
```{r plot_centroids}
#| label: fig-centroids
#| fig-cap: "Centroids of the 8 clusters created on the sphere, thus representing the prototypical embeddings of 8 groups (i.e. groups of species here). ***Interact with the figures to see the details.***"
