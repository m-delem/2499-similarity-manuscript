...
{{< embed notebooks/simulation-code.qmd#fig-osv-model >}}
...
:::{.column-page-inset}
```{r plot_sphere}
#| label: fig-perfect-embeddings-a
...
:::{#fig-subject-embeddings-box .column-page-inset}
```{r plot_embeddings_subjects}
...
:::{#fig-clusters-embeddings-final-box .column-page-inset}
```{r plot_clusters_embeddings_final}
#| label: fig-clusters-embeddings-final
