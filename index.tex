...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Project inception}, leftrule=.75mm, titlerule=0mm, bottomrule=.15mm, coltitle=black, bottomtitle=1mm, colframe=quarto-callout-tip-color-frame, left=2mm, arc=.35mm, opacityback=0, breakable, colback=white, opacitybacktitle=0.6, rightrule=.15mm, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, toptitle=1mm]
...
visual-spatial-verbal dimensions in Figure~\ref{fig-plot_osv_model}.
...
\phantomsection\label{osv_model}
\begin{Shaded}
\begin{Highlighting}[]
...
\phantomsection\label{cell-fig-plot_osv_model}
\begin{figure}[H]

\centering{

\includegraphics{index_files/figure-pdf/fig-plot_osv_model-1.png}

}

\caption{\label{fig-plot\_osv\_model}Imagery profiles generated for 30
