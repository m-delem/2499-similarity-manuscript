...
\CommentTok{\# adding the classification to the data}
\NormalTok{df\_embeds }\OperatorTok{\textless{}{-}}\NormalTok{ df\_embeds }\OperatorTok{|\textgreater{}}\NormalTok{ mutate(group }\OperatorTok{=} \ImportTok{as}\NormalTok{.factor(clusters$classification))}

\CommentTok{\# getting the centroids of each cluster}
\NormalTok{df\_centroids }\OperatorTok{\textless{}{-}} 
\NormalTok{  df\_embeds }\OperatorTok{|\textgreater{}} 
\NormalTok{  group\_by(group) }\OperatorTok{|\textgreater{}} 
\NormalTok{  summarise(}
\NormalTok{    x\_centroid }\OperatorTok{=}\NormalTok{ mean(x),}
\NormalTok{    y\_centroid }\OperatorTok{=}\NormalTok{ mean(y),}
\NormalTok{    z\_centroid }\OperatorTok{=}\NormalTok{ mean(z)}
\NormalTok{  )}

\CommentTok{\# adding them to the data}
\NormalTok{df\_embeds\_2 }\OperatorTok{\textless{}{-}}\NormalTok{ left\_join(df\_embeds, df\_centroids, by }\OperatorTok{=} \StringTok{"group"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\textsubscript{Source:
\href{https://m-delem.github.io/2499-similarity-manuscript/notebooks/simulation-code-preview.html\#cell-generating-sphere}{Study
simulation}}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# defining the variance and covariance of the distributions}
\NormalTok{var2 }\OperatorTok{\textless{}{-}} \FloatTok{0.05}
\NormalTok{cov2 }\OperatorTok{\textless{}{-}} \DecValTok{0}

\CommentTok{\# generating multivariate distributions around the categorical 3D means}
\NormalTok{df\_embeds\_visual }\OperatorTok{\textless{}{-}}
\NormalTok{  tibble(}
    \BuiltInTok{id} \OperatorTok{=} \ImportTok{as}\NormalTok{.factor(seq(}\DecValTok{1}\NormalTok{,}\DecValTok{6400}\NormalTok{)),}
\NormalTok{    category }\OperatorTok{=} \ImportTok{as}\NormalTok{.factor(rep(seq(}\DecValTok{1}\NormalTok{:}\DecValTok{64}\NormalTok{), each }\OperatorTok{=} \DecValTok{100}\NormalTok{))}
\NormalTok{  )}\OperatorTok{|\textgreater{}} 
\NormalTok{  group\_by(category) }\OperatorTok{|\textgreater{}} 
\NormalTok{  sim\_discr(}
\NormalTok{    n\_vars }\OperatorTok{=} \DecValTok{1}\NormalTok{, }
\NormalTok{    var }\OperatorTok{=}\NormalTok{ var2, }
\NormalTok{    cov }\OperatorTok{=}\NormalTok{ cov2, }
\NormalTok{    group\_means }\OperatorTok{=}\NormalTok{ df\_embeds\_categ$x, }
\NormalTok{    name }\OperatorTok{=} \StringTok{"x"}\NormalTok{) }\OperatorTok{|\textgreater{}} 
\NormalTok{  sim\_discr(}
\NormalTok{    n\_vars }\OperatorTok{=} \DecValTok{1}\NormalTok{, }
\NormalTok{    var }\OperatorTok{=}\NormalTok{ var2, }
\NormalTok{    cov }\OperatorTok{=}\NormalTok{ cov2, }
\NormalTok{    group\_means }\OperatorTok{=}\NormalTok{ df\_embeds\_categ$y, }
\NormalTok{    name }\OperatorTok{=} \StringTok{"y"}\NormalTok{) }\OperatorTok{|\textgreater{}} 
\NormalTok{  sim\_discr(}
\NormalTok{    n\_vars }\OperatorTok{=} \DecValTok{1}\NormalTok{, }
\NormalTok{    var }\OperatorTok{=}\NormalTok{ var2, }
\NormalTok{    cov }\OperatorTok{=}\NormalTok{ cov2, }
\NormalTok{    group\_means }\OperatorTok{=}\NormalTok{ df\_embeds\_categ$z, }
\NormalTok{    name }\OperatorTok{=} \StringTok{"z"}\NormalTok{) }\OperatorTok{|\textgreater{}} 
  \CommentTok{\# keeping only 8 points per distribution}
  \BuiltInTok{slice}\NormalTok{(}\DecValTok{1}\NormalTok{) }\OperatorTok{|\textgreater{}} 
\NormalTok{  ungroup() }\OperatorTok{|\textgreater{}} 
\NormalTok{  mutate(group }\OperatorTok{=} \ImportTok{as}\NormalTok{.factor(rep(seq(}\DecValTok{1}\NormalTok{, }\DecValTok{8}\NormalTok{), each }\OperatorTok{=} \DecValTok{8}\NormalTok{))) }\OperatorTok{|\textgreater{}} 
\NormalTok{  rename(x }\OperatorTok{=}\NormalTok{ x\_1, y }\OperatorTok{=}\NormalTok{ y\_1, z }\OperatorTok{=}\NormalTok{ z\_1) }\OperatorTok{|\textgreater{}} 
\NormalTok{  select(group, x, y, z)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=10.42in,height=1.06in]{index_files/figure-latex/mermaid-figure-3.png}
