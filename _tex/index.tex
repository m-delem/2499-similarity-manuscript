...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, bottomtitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, leftrule=.75mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Project inception}, colframe=quarto-callout-tip-color-frame, toptitle=1mm, breakable, bottomrule=.15mm, coltitle=black, colback=white, left=2mm, toprule=.15mm, titlerule=0mm, arc=.35mm, rightrule=.15mm, opacitybacktitle=0.6]
...
\includegraphics[width=0.5\textwidth,height=\textheight]{images/mur-spam-2.png}

}

\subcaption{\label{fig-spam-mur}Arena layout of the MA protocol used by
\citet{murHumanObjectSimilarityJudgments2013} to acquire perceptual
similarity judgements on natural images.}
...
\includegraphics[width=0.65\textwidth,height=\textheight]{images/majewska-spam-2.png}

}

\subcaption{\label{fig-majewska}Arena layout of the MA protocol used by
...
\includegraphics[width=0.6\textwidth,height=\textheight]{images/shapes-marr.png}
...
\includegraphics[width=0.7\textwidth,height=\textheight]{images/kawa-gwot-2.PNG}
...
\phantomsection\label{cell-fig-osv-model}
\begin{figure}[H]

\centering{

\includegraphics{index_files/figure-pdf/fig-osv-model-1.png}
...
\includegraphics{index_files/figure-pdf/fig-perfect-embeddings-pdf-1.png}

}

\subcaption{\label{fig-perfect-embeddings-pdf-1}Generated spherical
...
\includegraphics{index_files/figure-pdf/fig-perfect-embeddings-pdf-2.png}

}

\subcaption{\label{fig-perfect-embeddings-pdf-2}Centroids of the 8
clusters created on the sphere.}

\end{minipage}%

\caption{\label{fig-perfect-embeddings-pdf}Initial random generations of
...
\includegraphics{index_files/figure-pdf/fig-subject-embeddings-pdf-1.png}

}

\subcaption{\label{fig-subject-embeddings-pdf-1}Distribution of the
...
\includegraphics{index_files/figure-pdf/fig-subject-embeddings-pdf-2.png}

}

\subcaption{\label{fig-subject-embeddings-pdf-2}Distribution of the
...
\caption{\label{fig-subject-embeddings-pdf}Final distribution of the 64
...
\phantomsection\label{cell-fig-osv-clusters}
\begin{figure}[H]

\centering{

\includegraphics{index_files/figure-pdf/fig-osv-clusters-1.png}
...
\includegraphics{index_files/figure-pdf/fig-clusters-final-pdf-1.png}

}

\subcaption{\label{fig-clusters-final-pdf-1}\textbf{Cluster 1}
...
\includegraphics{index_files/figure-pdf/fig-clusters-final-pdf-2.png}

}

\subcaption{\label{fig-clusters-final-pdf-2}\textbf{Cluster 2}
...
\includegraphics{index_files/figure-pdf/fig-clusters-final-pdf-3.png}

}

\subcaption{\label{fig-clusters-final-pdf-3}\textbf{Cluster 3}
embeddings (Spatial aphantasic cluster).Within-cluster aligment accuracy
= 94.01\%.}
...
\includegraphics{index_files/figure-pdf/fig-clusters-final-pdf-4.png}

}

\subcaption{\label{fig-clusters-final-pdf-4}\textbf{Cluster 4}
embeddings (Aphantasic cluster).Within-cluster aligment accuracy =
85.03\%.}
...
\includegraphics{index_files/figure-pdf/fig-clusters-final-pdf-5.png}

}

\subcaption{\label{fig-clusters-final-pdf-5}\textbf{Cluster 5}
...
\includegraphics{index_files/figure-pdf/fig-clusters-final-pdf-6.png}

}

\subcaption{\label{fig-clusters-final-pdf-6}\textbf{Cluster 6}
embeddings (Verbal aphantasic cluster).Within-cluster aligment accuracy
= 81.80\%.}
...
\includegraphics{index_files/figure-pdf/fig-clusters-final-pdf-7.png}

}

\subcaption{\label{fig-clusters-final-pdf-7}\textbf{Cluster 7}
...
\includegraphics{index_files/figure-pdf/fig-clusters-final-pdf-8.png}

}

\subcaption{\label{fig-clusters-final-pdf-8}\textbf{Cluster 8}
embeddings (Phantasic cluster).Within-cluster aligment accuracy =
74.64\%.}
...
\includegraphics{index_files/figure-pdf/fig-clusters-final-pdf-9.png}

}

\subcaption{\label{fig-clusters-final-pdf-9}\textbf{Cluster 9}
embeddings (Phantasic cluster).Within-cluster aligment accuracy =
42.45\%.}
