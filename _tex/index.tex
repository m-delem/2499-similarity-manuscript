...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, toptitle=1mm, colframe=quarto-callout-tip-color-frame, breakable, arc=.35mm, opacityback=0, colbacktitle=quarto-callout-tip-color!10!white, leftrule=.75mm, toprule=.15mm, left=2mm, coltitle=black, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Project inception}, bottomrule=.15mm, rightrule=.15mm, titlerule=0mm, opacitybacktitle=0.6, colback=white]
