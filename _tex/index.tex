...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, left=2mm, toprule=.15mm, colback=white, toptitle=1mm, leftrule=.75mm, opacityback=0, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Project inception}, breakable, opacitybacktitle=0.6, titlerule=0mm, colbacktitle=quarto-callout-tip-color!10!white, rightrule=.15mm, arc=.35mm, colframe=quarto-callout-tip-color-frame, bottomrule=.15mm, coltitle=black]
